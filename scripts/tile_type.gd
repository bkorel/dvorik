...
const STONE_FACE := Color(0.50, 0.51, 0.54)
const ROOF_SLAB := Color(0.085, 0.095, 0.115)
const ROOF_EDGE := Color(0.04, 0.045, 0.055)
const ROOF_SHEEN := Color(0.36, 0.37, 0.40)
...
const PORCH_EDGE := Color(0.16, 0.17, 0.19)
