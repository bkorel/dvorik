...
const WATER_PUDDLE := Color(0.18, 0.40, 0.55)
const REFLECTION := Color(0.14, 0.10, 0.07, 0.72)
const PATH_SHADE := Color(0.36, 0.22, 0.10)
const PATH_GROOVE := Color(0.26, 0.15, 0.07)
const REED := Color(0.34, 0.42, 0.18)
const YARD_BUSH := Color(0.30, 0.46, 0.20)
const YARD_PEG := Color(0.42, 0.28, 0.14)
const PORCH := Color(0.62, 0.42, 0.22)
